...
```
#> [1] "1.02_Hello-World.html"  "1.02_Hello-World.md"    "2.02_PCA-example.html"  "2.02_PCA-example.md"    "2.02_PCA-example_files"
#> [6] "Hello_World.txt"        "PCA_Eigenvectors.pdf"   "PCA_Eigenvectors.tiff"
```
...
#>  [1] Rcpp_1.0.6        highr_0.9         cellranger_1.1.0  pillar_1.6.0      compiler_4.0.4    tools_4.0.4       digest_0.6.27    
#>  [8] evaluate_0.14     lifecycle_1.0.0   tibble_3.1.1      gtable_0.3.0      pkgconfig_2.0.3   rlang_0.4.10      rstudioapi_0.13  
#> [15] cli_2.5.0         yaml_2.2.1        xfun_0.22         gridExtra_2.3     withr_2.4.2       stringr_1.4.0     dplyr_1.0.5      
#> [22] knitr_1.33        generics_0.1.0    vctrs_0.3.8       rprojroot_2.0.2   grid_4.0.4        tidyselect_1.1.0  glue_1.4.2       
#> [29] R6_2.5.0          fansi_0.4.2       farver_2.1.0      tidyr_1.1.3       purrr_0.3.4       magrittr_2.0.1    scales_1.1.1     
#> [36] ellipsis_0.3.2    htmltools_0.5.1.1 colorspace_2.0-0  renv_0.13.2       labeling_0.4.2    utf8_1.2.1        tinytex_0.31     
#> [43] stringi_1.5.3     munsell_0.5.0     crayon_1.4.1
```
